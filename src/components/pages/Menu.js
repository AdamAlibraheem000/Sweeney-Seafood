...
export default function Contact() {
  return (
    <article class="scroll-menu">
        ...
        <div class="food-2">
          <h5 class="food-3">Land and Sea</h5>
          <p>
        ...
        {/* <!-- Sides --> */}
        <section id="sides-section" class="food-title">
          <h2>
            HOUSE-MADE SIDES <span class="price-styling">+2.50 each</span>
          </h2>
          <p class="sides-styling">
